...
# # print(Count)
#
# # # 让电脑随机产生字母，逐个把他们送到磁盘上面去，直到输入一个O为止

# with open("/Users/jason/Downloads/未命名1.txt", "a", encoding="utf-8") as FILE:
#     FILE.write("\n代码你好")
#     # REAd = FILE.read()
#     # print(REAd)
#
# with open("/Users/jason/Downloads/未命名1.txt", "r", encoding="utf-8") as file:
#     reaD = file.read()
#     print(reaD)
#
# with open("/Users/jason/Downloads/未命名1.txt", "w", encoding="utf-8") as New_file:
#     with open("/Users/jason/Downloads/未命名1.txt", "r", encoding="utf-8") as  Old_fle:
#         ReaD = Old_fle.read()
#         print(ReaD)
...
#
# 从键盘输入一个字符串，将小写字母全部换成大写字母，然后输出到一个磁盘文件"test"中保存，输入的字符串用！结束
# little = input("enter:")
# Big = little.upper()
